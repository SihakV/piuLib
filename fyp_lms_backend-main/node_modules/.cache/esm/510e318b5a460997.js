_5a4‍.x([["jwtconfig",()=>jwtconfig],["dbconfig",()=>dbconfig],["initalrole",()=>initalrole],["getgooglebook",()=>getgooglebook],["deleteObject",()=>deleteObject],["generateQRCodeAndUploadToS3",()=>generateQRCodeAndUploadToS3],["generateExcel",()=>generateExcel]]);const fetch = require('node-fetch');
...
const S3 = new AWS.S3(awsS3config);
    ...
    await S3.deleteObject(params, function (err, data) {
       ...
       async function generateQRCodeAndUploadToS3(text, bucketName, key) {
...
//GENERATE REPORT
       ...
       const generateExcel = (data, information, informationtypes, generateddate) => {
