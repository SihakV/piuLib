_5a4‍.x([["getstudentapi",()=>getstudentapi],["registerStudent",()=>registerStudent],["resetPassword",()=>resetPassword],["delete_student",()=>delete_student],["editstudent",()=>editstudent],["editlibrarian",()=>editlibrarian],["register_HD",()=>register_HD],["createLibrarian",()=>createLibrarian],["scanEntry",()=>scanEntry],["getStudentInfo",()=>getStudentInfo],["getStudentList",()=>getStudentList],["borrowBook",()=>borrowBook],["getToPickpBook",()=>getToPickpBook],["pickupandreturnbook",()=>pickupandreturnbook],["handleIndividualReturn",()=>handleIndividualReturn],["getborrowbook_librarian",()=>getborrowbook_librarian],["getborrowbook_student",()=>getborrowbook_student],["deletepickup_borrow",()=>deletepickup_borrow],["deleteborrow_book",()=>deleteborrow_book],["exportreport",()=>exportreport]]);const { Op } = require('sequelize');
...
const handleresetemail = async (data) => {
    ...
    db.librarian
       ...
       const register_HD = async (req, res) => {
...
const lateday = (date, duedate) => {
    ...
    return daysLate;
       ...
       const pickupandreturnbook = async (req, res) => {
    ...
    if (operation === 'pickup') {
       ...
       const handleIndividualReturn = async (req, res) => {
...
const dayleft = (enddate) => {
    ...
    return leftday;
       ...
       const getborrowbook_librarian = async (req, res) => {
    try {
        const date = new Date();
       ...
       const getborrowbook_student = async (req, res) => {
    try {
        const { ID } = req.params;
        const date = new Date();
       ...
       const deletepickup_borrow = async () => {
    ...
    try {
       ...
       const deleteborrow_book = (req, res) => {
    const { id } = req.body;
